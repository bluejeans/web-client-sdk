...
import { WaitingContainer, LocalVideoHolderTest, PreviewHolder, ToggleButton } from "./styles/WaitingRoom";
...
export default class WaitingRoom extends Component<Props> {
    ...
    componentDidMount() {
        this.waitingRoomViewModel.attachPreviewVideo(this.previewVideoElement.current);
    }
    render() {
        return (
            <WaitingContainer>
                <PreviewHolder>
                    ...
                    <ToggleButton onClick={this.waitingRoomViewModel.togglePreview.bind(this.waitingRoomViewModel)}>{this.waitingRoomViewModel.isVideoMuted?"Unmute Video":"Mute Video"}</ToggleButton>
