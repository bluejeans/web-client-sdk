...
import { LocalVideoHolder, SharedScreenHolder, VideoHolder, VideoMessage, BuildInfo, Container, CaptionTextContainer, CaptionTextSpan, RightContainer, NoContentShared } from "./styles/Common";
...
export default class SampleApp extends Component<Props> {
    ...
    componentDidUpdate(prevProps: Readonly<Props>, prevState: Readonly<{}>, snapshot?: any): void {
        ...
        if (!vm.screenShareOnly && (vm.isLayoutTransitionFromCUSTOMToBJN || vm.renderMeetingView)) {
        ...
        return (
            <Container>
                <RightContainer>
                    ...
                    { this.viewModel.screenShareOnly && this.viewModel.isMeetingConnected && !this.viewModel.showRemoteContent && (
