...
class InfoBar extends React.Component<PropsInfo> {
  ...
  render() {
    return (
      <InfoBarMain>
        <LeftInnerContainer onClick={this.infoBarViewModel.switchToParticipantsView}>
          {this.infoBarViewModel.showParticipantName && this.infoBarViewModel?.participantName}
        </LeftInnerContainer>
        <RightInnerContainer>
          <ImCross
