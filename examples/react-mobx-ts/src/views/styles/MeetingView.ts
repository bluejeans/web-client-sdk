...
let video_off_remote =
  require('../../../assets/icons/video_off_remote.svg').default
let audio_off_remote =
  require('../../../assets/icons/audio_off_remote.svg').default
let moderator_badge =
  require('../../../assets/icons/moderator_star.svg').default
...
export const DarkMeetingDetailsTableRow = styled.tr`
  color: black;
`
...
export const AudioIcon = styled<any, any>('div')`
  ...
  display: inline-block;
  vertical-align: middle;
  background: url(${(props) => (props.isMuted ? audio_off : audio_on)})
    no-repeat center;
`
export const PinnedParticipantController = styled<any, any>('div')`
  ...
  display: inline-block;
  vertical-align: middle;
  background: url(${(props) => (props.isEnabled ? pin_enable : pin_initial)})
    no-repeat center;
  cursor: pointer;
`
export const AudioIconRemote = styled<any, any>('div')`
  ...
  display: inline-block;
  vertical-align: middle;
  background: url(${(props) => (props.isMuted ? audio_off_remote : audio_on)})
    no-repeat center;
`
...
export const VideoIcon = styled<any, any>('div')`
  ...
  display: inline-block;
  vertical-align: middle;
  background: url(${(props) => (props.isMuted ? video_off : video_on)})
    no-repeat center;
`
export const VideoIconRemote = styled<any, any>('div')`
  ...
  display: inline-block;
  vertical-align: middle;
  background: url(${(props) => (props.isMuted ? video_off_remote : video_on)})
    no-repeat center;
`
