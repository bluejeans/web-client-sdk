  ...
  render() {
    return (
      <CustomContainerDiv>
        ...
        <MainStage
          id='moderator'
          participant={this.customLayoutViewModel.firstModerator}
          managers={this.props.managers}
          streams={this.customLayoutViewModel.getStreamsForFirstModerator}
        />
        <MainStage
          id='pinnedParticipant'
          participant={this.customLayoutViewModel.getPinnedParticipantDetails}
          managers={this.props.managers}
          streams={this.customLayoutViewModel.streamsForPinnedParticipant}
        />
          ...
          (obj, index) => {
            return (
              <Thumbnail
                ...
                managers={this.props.managers}
                streams={this.customLayoutViewModel.videoStreamsMap.get(
                  obj.participantGuid,
                )}
              />
            )
        ...
        <Random onClick={this.setRandomColour}>
          {this.state.randomColur && '✓'}Randomize
        </Random>
      </CustomContainerDiv>
    )
  }
