...
export default class ModeratorViewModel {
    ...
    constructor(managers: Managers) {
        ...
        this.customLayoutViewModel = new CustomLayoutViewModel(managers)
    }

    renderParticipants(participantGuid, element) {
        this.webrtcSDK.meetingService.videoStreamService?.attachParticipantToView(participantGuid, <HTMLDivElement>document.getElementById(`${element}`))
    }
